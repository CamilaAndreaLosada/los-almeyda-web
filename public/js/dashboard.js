    ...
    if (productForm) {
        productForm.addEventListener('submit', async (e) => {
            ...
            const data = {
                ...
                unidad: document.getElementById('product-unit').value // Obtener la unidad
            };
    ...
    if (recipeForm) {
        recipeForm.addEventListener('submit', async (e) => {
            ...
            const data = {
                ...
                instrucciones: document.getElementById('recipe-instructions').value,
                imagen_url: document.getElementById('recipe-image-url').value
            };

            if (!data.titulo || !data.ingredientes || !data.instrucciones) {
            ...
            try {
                ...
                showMessage('Error de conexión al registrar receta.', 'error');
            } finally {
                toggleLoading(false);
            }
        });
